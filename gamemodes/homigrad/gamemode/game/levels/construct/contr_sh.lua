...
function CLASS:EndRound(winner)
	if roundActiveName == "construct" and winner == 2 then
...
if SERVER then
	util.AddNetworkString("construct contr")

	net.Receive("construct contr",function(len,ply)
