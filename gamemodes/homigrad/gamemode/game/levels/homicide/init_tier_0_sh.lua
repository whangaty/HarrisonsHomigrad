    ...
    if startRound > 0 and lply:Alive() then
        ...
        if lply.roleT then --Traitor
            ...
            elseif homicide.roundType == 5 then --wildwest
                draw.DrawText( "You have a sniper rifle.\nDespite its large size, it is hidden from your character.", "HomigradRoundFont", ScrW() / 2, ScrH() / 1.1, Color( color.r,color.g,color.b,math.Clamp(startRound,0,1) * 255 ), TEXT_ALIGN_CENTER )
            else --emergency/base
