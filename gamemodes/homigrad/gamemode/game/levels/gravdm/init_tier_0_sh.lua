...
dm = {}
dm.Name = "Gravity Gun Gambit (Free for All)"
...
function dm.HUDPaint_RoundLeft(white)
    ...
    if startRound > 0 and lply:Alive() then
        ...
        draw.DrawText( "Gravity Gun Gambit (Free for All)", "HomigradFontBig", ScrW() / 2, ScrH() / 1.2, Color( 55,55,55,math.Clamp(startRound - 0.5,0,1) * 255 ), TEXT_ALIGN_CENTER )
        return
    end
end
