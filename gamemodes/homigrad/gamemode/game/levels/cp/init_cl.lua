...
function cp.HUDPaint_RoundLeft(white2) --позиции точек и счёт
    ...
    if startRound > 0 and lply:Alive() then
        ...
        draw.DrawText( "Capture & Hold Points! Get points as you hold points, and win the game!", "HomigradFontBig", ScrW() / 2, ScrH() / 1.2, Color( 155,155,155,math.Clamp(startRound,0,1) * 255 ), TEXT_ALIGN_CENTER )
        return
    end
