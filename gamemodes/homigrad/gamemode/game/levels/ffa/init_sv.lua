...
function ffa.StartRoundSV()
    ...
    local aviable = ReadDataMap("dm") --; idk how it works
...
function ffa.EndRound(winner, topPlayer)
    if winner then
...
hook.Add("EntityTakeDamage", "TrackPlayerDamage", function(target, dmgInfo)
...
hook.Add("PlayerDeath", "CustomKillSystem", function(victim, inflictor, attacker)
